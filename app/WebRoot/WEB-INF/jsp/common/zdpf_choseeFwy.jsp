...
<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择服务业信息</div>
	<div id="main" style="padding:0px;margin:0 auto; width:99%;height:380px; border:1px solid #95b8e7; ">
		<div  style="float:left; width:75%;height:380px; border:0px solid #95b8e7; ">
			<div  id="questionContainer" style="margin:16px auto 0px;">
				<form id="queryForm" action="queryFwyList.json" method="post">
				    <input type="hidden" id="id" name="lawobjtype" value="${id}" />
		...
		<div style="float:right;width:24.5%;height:380px; border-bottom:0px solid #95b8e7;border-left:1px solid #95b8e7;border-top:none;">
			<h1 style="height:30px;font-size: 16px;" align="center">您选择的服务业企业信息</h1>
			<table id="choseedata">
			</table>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$("#save").click(function(){
		...
		for(var i=0;i<rows.length;i++){
		    ...
		    //调用父窗口方法
		   window.parent.setloawObj(ids, names);
