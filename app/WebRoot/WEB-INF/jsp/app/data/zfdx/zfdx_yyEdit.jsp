...
.tabs li a.tabs-inner {
	...
	<body style="padding-bottom: 70px;">
		...
		<form id="queryForm" action="saveyy.json" method="post">
			<input type="hidden" id="fid" name="fid" value="${fid}" />
			<input type="hidden" id="id" name="id" value="${yyForm.id}"/>
			<input type="hidden" id="lawobjtypeid" name="lawobjtypeid" value="${lawobjtypeid}"/>
			<input type="hidden" id="lawobjfid" name="lawobjfid" value="${yyForm.lawobjfid}"/>
			<input type="hidden" id="jsxmid" name="jsxmid" value="${yyForm.jsxmid}"/>
			<input type="hidden" id="qyscztj" name="qyscztj" value='${yyForm.qysczt}'/>
...
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='zzjgdm'  data-options='required:true'  id='zzjgdm'>${yyForm.zzjgdm}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>单位名称：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwmc'  data-options='required:true'  id='dwmc' >${yyForm.dwmc}</textarea></td>
</tr>
...
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwdz'  data-options='required:true'  id='dwdz' value=''>${yyForm.dwdz}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属行政区：</td>
<td >
<input class='i-text' type='text'  name='ssxzq' id='ssxzq' value='${yyForm.ssxzq}' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>行业：</td>
<td >
<input class='i-text' type='text'  name='hylx' id='hylx' value='${yyForm.hylx}' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
经度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='jddu' id='jddu' value="${yyForm.jddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdfen' id='jdfen' value="${yyForm.jdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdmiao' id='jdmiao'value="${yyForm.jdmiao}"/>秒</td>
<td width='150' bgcolor='#edfaff' align='right'>
纬度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='wddu' id='wddu' value="${yyForm.wddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdfen' id='wdfen' value="${yyForm.wdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdmiao' id='wdmiao' value="${yyForm.wdmiao}"/>秒</td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbr' id='fddbr' value="${yyForm.fddbr}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbrdh' id='fddbrdh' value="${yyForm.fddbrdh}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzr' id='hbfzr' value="${yyForm.hbfzr}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzrdh' id='hbfzrdh' value="${yyForm.hbfzrdh}"/></td>
</tr>

<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>辐射安全许可证：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fsaqxkz' id='fsaqxkz' value="${yyForm.fsaqxkz}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>排污许可证：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pwxkz' id='pwxkz' value="${yyForm.pwxkz}"  data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>职业资质证：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zyzzz' id='zyzzz'  value="${yyForm.zyzzz}"  data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
废水排放口个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fspfks' id='fspfks' value="${yyForm.fspfks}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
企业规模：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qygm' id='qygm' value='${yyForm.qygm}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
废气排放口个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fqpfks' id='fqpfks' value="${yyForm.fqpfks}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
噪声源个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='zsygs' id='zsygs' value="${yyForm.zsygs}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
固废堆放场个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='gfdfcgs' id='gfdfcgs' value="${yyForm.gfdfcgs}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
污染源防治设施数量：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='wryfzsssl' id='wryfzsssl' value="${yyForm.wryfzsssl}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
床位数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='cws' id='cws' value="${yyForm.cws}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
放射源数量：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fsysl' id='fsysl' value="${yyForm.fsysl}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
射线装置：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='sxzz' id='sxzz' value="${yyForm.sxzz}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属网格区域：</td>
<td>
<input class='i-text ' type='text'  name='sswgqy' id='sswgqy' value="${yyForm.sswgqy}" /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属监管部门：</td>
<td>
<input class='i-text' type='text'  name='ssjgbm' id='ssjgbm' value='${yyForm.ssjgbm}' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
企业状态：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qyzt' id='qyzt' value='${yyForm.qyzt}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
创建人：</td>
<td>
<c:if test="${yyForm.id==null}">
...
<c:if test="${yyForm.id !=null&& yyForm.id!=''}">
<input class='i-text' type='text' style='border-left:0px;border-top:0px;border-right:0px;border-bottom:1px '  name='cjr' id='cjr' value="${yyForm.cjr}" /></td>
</c:if>
</tr>
...
投产日期：</td>
<td>
<input class='easyui-datebox' type='text'  name='tcrq'  id='tcrq' value='${yyForm.tcrq}' data-options='editable:false' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
邮政编码：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yzbm' id='yzbm' value='${yyForm.yzbm}'/></td>
</tr>
...
$('#hylx').combobox({required:true,url:'industryList.json?lawobjType=3',valueField:'id',textField:'name'});
		...
		submitHandler:function(form){
			if($("#queryForm").form("validate")){
				$("#queryForm").ajaxSubmit({
					...
					success: function(data){
						if(data.state){
							 /*$.messager.alert("保存医院:", data.msg, "info", function () {
								    //self.close();
