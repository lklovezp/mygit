...
.tabs li a.tabs-inner {
	...
	<body style="padding-bottom: 70px;">
		...
		<form id="queryForm" action="savefwy.json" method="post">
			<input type="hidden" id="fid" name="fid" value="${fid}" />
			<input type="hidden" id="id" name="id" value="${fwyForm.id}"/>
			<input type="hidden" id="lawobjtypeid" name="lawobjtypeid" value="${lawobjtypeid}"/>
			<input type="hidden" id="lawobjfid" name="lawobjfid" value="${fwyForm.lawobjfid}"/>
			<input type="hidden" id="jsxmid" name="jsxmid" value="${fwyForm.jsxmid}"/>
			<input type="hidden" id="qyscztj" name="qyscztj" value='${fwyForm.qysczt}'/>
...
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwmc'  data-options='required:true'  id='dwmc' >${fwyForm.dwmc}</textarea></td><td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属行政区：</td>
<td>
<input class='i-text' type='text'  name='ssxzq' id='ssxzq' value='${fwyForm.ssxzq}' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbr' id='fddbr'  value='${fwyForm.fddbr}'  data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbrdh' id='fddbrdh' value='${fwyForm.fddbrdh}' data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzr' id='hbfzr' value='${fwyForm.hbfzr}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzrdh' id='hbfzrdh' value='${fwyForm.hbfzrdh}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
经度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='jddu' id='jd' value="${fwyForm.jddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdfen' id='jdfen' value="${fwyForm.jdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdmiao' id='jdmioa'value="${fwyForm.jdmiao}"/>秒</td>
<td width='150' bgcolor='#edfaff' align='right'>
纬度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='wddu' id='wddu' value="${fwyForm.wddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdfen' id='wdfen' value="${fwyForm.wdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdmiao' id='wdmiao' value="${fwyForm.wdmiao}"/>秒</td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>地址：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwdz'  data-options='required:true'  id='dwdz' >${fwyForm.dwdz}</textarea></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>营业执照注册号：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yyzzzch' id='yyzzzch' value='${fwyForm.yyzzzch}' data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属监管部门：</td>
<td>
<input class='i-text' type='text'  name='ssjgbm' id='ssjgbm' value='${fwyForm.ssjgbm}' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>行业：</td>
<td>
<input class='i-text' type='text'  name='hylx' id='hylx' value='${fwyForm.hylx}' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
创建人：</td>
<td>
<c:if test="${fwyForm.id==null}">
...
<c:if test="${fwyForm.id !=null&& fwyForm.id!=''}">
<input class='i-text' type='text' style='border-left:0px;border-top:0px;border-right:0px;border-bottom:1px '  name='cjr' id='cjr' value="${fwyForm.cjr}" /></td>
</c:if>
<td width='150' bgcolor='#edfaff' align='right'>
所属网格：</td>
<td>
<input class='i-text ' type='text'  name='sswgqy' id='sswgqy' value="${fwyForm.sswgqy}"/></td>
...
发证时间：</td>
<td>
<input class='easyui-datebox' type='text'  name='fzsj'  id='fzsj' value='${fwyForm.fzsj}' data-options='editable:false' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
底商：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='ds' id='ds' value='${fwyForm.ds}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
位于几层：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='wyjc' id='wyjc' value='${fwyForm.wyjc}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
住宅：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zz' id='zz' value='${fwyForm.zz}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
商服：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='sf' id='sf' value='${fwyForm.sf}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
周围环境：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='zwhj'  id='zwhj' >${fwyForm.zwhj}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
面积㎡：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='mj' id='mj' value='${fwyForm.mj}'/> </td>
			
			<td width='150' bgcolor='#edfaff' align='right'>
房间：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fj' id='fj' value='${fwyForm.fj}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
人员：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='ry' id='ry' value='${fwyForm.ry}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
柜子：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='gz' id='gz' value='${fwyForm.gz}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
淋浴头：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='lyt' id='lyt' value='${fwyForm.lyt}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
天然气：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='trq' id='trq' value='${fwyForm.trq}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
锅炉（台/吨）：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='gl' id='gl' value='${fwyForm.gl}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
电热水器：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='drsq' id='drsq' value='${fwyForm.drsq}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
床位：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='cw' id='cw' value='${fwyForm.cw}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
空调：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='kt' id='kt' value='${fwyForm.kt}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
锅炉（冬季供暖）：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='djgngl' id='djgngl' value='${fwyForm.djgngl}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
集中供热：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='jzgr' id='jzgr' value='${fwyForm.jzgr}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
洗车机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='xcj' id='xcj' value='${fwyForm.xcj}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
泡沫机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pmj' id='pmj' value='${fwyForm.pmj}'/></td>
</tr>
...
企业状态：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qyzt' id='qyzt' value='${fwyForm.qyzt}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
备注：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='bz'  id='bz' >${fwyForm.bz}</textarea></td>
</tr>
...
<input type='checkbox' name='qysczt' id='qysczt' value='12'/> 12月</span>
				...
				<div class="panel-header" style="margin-top:10px;">
					<div class="panel-title" bgcolor="#edfaff" align="right">
						附件信息
					</div>
				</div>
...
$('#hylx').combobox({required:true,url:'industryList.json?lawobjType=8',valueField:'id',textField:'name'});
...
$('#djgngl').combobox({url:'sfList.json',valueField:'id',textField:'name'});
	...
	$("#fjlx").combobox({
		url:'fjlxList.json?enumName=FWY',
		valueField:'id',
		textField:'name'
	});
