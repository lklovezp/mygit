...
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwmc'  data-options='required:true'  id='dwmc' >${zzyForm.dwmc}</textarea></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属行政区：</td>
<td>
<input class='i-text' type='text'  name='ssxzq' id='ssxzq' value='${zzyForm.ssxzq }' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbr' id='fddbr' value='${zzyForm.fddbr }'  data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbrdh' id='fddbrdh' value='${zzyForm.fddbrdh }'  data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzr' id='hbfzr' value='${zzyForm.hbfzr }' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzrdh' id='hbfzrdh' value='${zzyForm.hbfzrdh }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
经度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='jddu' id='jddu' value="${zzyForm.jddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdfen' id='jdfen' value="${zzyForm.jdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdmiao' id='jdmiao'value="${zzyForm.jdmiao}"/>秒</td>
<td width='150' bgcolor='#edfaff' align='right'>
纬度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='wddu' id='wddu' value="${zzyForm.wddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdfen' id='wdfen' value="${zzyForm.wdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdmiao' id='wdmiao' value="${zzyForm.wdmiao}"/>秒</td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>地址：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwdz'  data-options='required:true'  id='dwdz' >${zzyForm.dwdz }</textarea></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>营业执照注册号：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yyzzzch' id='yyzzzch' value='${zzyForm.yyzzzch }'  data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
发证时间：</td>
<td>
<input class='easyui-datebox' type='text'  name='fzsj'  id='fzsj' value='${zzyForm.fzsj }' data-options='editable:false' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
底商：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='ds' id='ds' value='${zzyForm.ds }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
位于几层：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='wyjc' id='wyjc' value='${zzyForm.wyjc }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
住宅：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zz' id='zz' value='${zzyForm.zz }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
商服：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'   name='sf' id='sf' >${zzyForm.sf }</textarea></td>
<input class='i-text easyui-validatebox' type='text' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
周围环境：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='zwhj'  id='zwhj' >${zzyForm.zwhj }</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
面积㎡：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='mj' id='mj' value='${zzyForm.mj }'/></td>

<td width='150' bgcolor='#edfaff' align='right'>
切割机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qgj' id='qgj' value='${zzyForm.qgj }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
角磨机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='jmj' id='jmj' value='${zzyForm.jmj }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
电钻：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='dz' id='dz' value='${zzyForm.dz }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
电锯：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='dj' id='dj' value='${zzyForm.dj }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
断剪钳：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='djq' id='djq' value='${zzyForm.djq }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
去籽机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qzj' id='qzj' value='${zzyForm.qzj }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
打包机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='dbj' id='dbj' value='${zzyForm.dbj }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
平磨机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pmj' id='pmj' value='${zzyForm.pmj }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
雕刻机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='dkj' id='dkj'  value='${zzyForm.dkj }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
镯子机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zzj' id='zzj' value='${zzyForm.zzj }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
抛光机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pgj' id='pgj' value='${zzyForm.pgj }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
电刨：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='dp' id='dp' value='${zzyForm.dp }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
隔声降噪措施：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='gsjzcs' id='gsjzcs' value='${zzyForm.gsjzcs }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
制作地点：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zzdd' id='zzdd' value='${zzyForm.zzdd }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
喷、刷油漆：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='psyq' id='psyq' value='${zzyForm.psyq }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属监管部门：</td>
<td>
<input class='i-text' type='text'  name='ssjgbm' id='ssjgbm'  value='${zzyForm.ssjgbm }'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
企业状态：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qyzt' id='qyzt' value='${zzyForm.qyzt }'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
所属网格区域：</td>
<td>
<input class='i-text ' type='text'  name='sswgqy' id='sswgqy' value="${zzyForm.sswgqy}" /></td>
...
备注：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='bz'  id='bz' >${zzyForm.bz }</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
...
$('#zz').combobox({url:'sfList.json',valueField:'id',textField:'name'});
	...
	$("#fjlx").combobox({
		url:'fjlxList.json?enumName=ZZY',
		valueField:'id',
		textField:'name'
	});
