...
<div id="searchForm" class="searchForm" style="padding-top:10px;padding-bottom:21px;">
					...
					<tr style="height:70px;">
						...
						<td>
							<input class="y-text" style="width:127px;" type="text" id="ssjgbm" name="orgId" value="${orgId}" />
						</td>
						<th width="120">
							企业状态：
						</th>
						<td>
							<input class="y-text" type="text" id="qyzt" value="0" name="qyzt" style="width: 127px;"/>
						</td>
					</tr>
					<tr>
...
<div id="layer1" class="layer"></div>
		<div class="h1_1 topMask" id="divTitle">选择制造业信息</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		onDblClickRow: function(rowIndex, rowData){
			<c:if test="${type=='edit'}">
				/*$.messager.confirm('选择制造业信息', "<table><tr><td>是否覆盖建设项目基础信息（</td></tr><tr><td>单位名称、</td></tr><tr><td>单位地址、</td></tr><tr><td>法定代表人、</td></tr><tr><td>法定代表人联系电话、<tr><td>环保负责人、</td></tr><tr><td>环保负责人联系电话）?</td></tr><div>", function(r){
					if (r){
...
//查看
function info(id){
	var href="zzyInfo.htm?id="+id;
	parent.parent.parent.layerIframe(2,href,"查看制造业信息","1000","575");
	//$.colorbox({iframe:true,width:"800", height:"500", scrolling:true, href:"fwyInfo.htm?id="+id});
	//All.ShowModalWin('fwyInfo.htm?id='+id, '查看服务业信息');
}
