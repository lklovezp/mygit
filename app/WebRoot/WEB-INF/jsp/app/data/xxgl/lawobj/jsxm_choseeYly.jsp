...
<div id="layer1" class="layer"></div>
		<div class="h1_1 topMask" id="divTitle">选择服务业信息</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		onDblClickRow: function(rowIndex, rowData){
			<c:if test="${type=='edit'}">
				/*$.messager.confirm('选择娱乐业信息', "<table><tr><td>是否覆盖建设项目基础信息（</td></tr><tr><td>单位名称、</td></tr><tr><td>单位地址、</td></tr><tr><td>法定代表人、</td></tr><tr><td>法定代表人联系电话、<tr><td>环保负责人、</td></tr><tr><td>环保负责人联系电话）?</td></tr><div>", function(r){
					if (r){
...
//查看
function info(id){
	var href="ylyInfo.htm?id="+id;
	parent.parent.parent.layerIframe(2,href,"查看娱乐业信息","1000","575");
	//$.colorbox({iframe:true,width:"800", height:"550", scrolling:true, href:"ylyInfo.htm?id="+id});
	//All.ShowModalWin('ylyInfo.htm?id='+id, '查看娱乐业信息');
}
