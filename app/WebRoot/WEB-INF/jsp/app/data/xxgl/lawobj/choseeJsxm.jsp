...
<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择建设项目</div>
	<div id="main" style="padding:0px;margin:0 auto; width:99%;height:518px; border:1px solid #95b8e7; ">
		<div  style="float:left; width:70%;height:518px; border:0px solid #95b8e7; ">
				...
				<form id="queryForm" action="queryJsxmList.json" method="post">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
					    ...
					    <tr style="height:70px;">
							...
							<th width="100">
							<a href="#" class="task_zflx"  id="selectlawobjId">单位名称：</a>
			...
			<div class="divContainer" id="infectlist" style="float:left;width:100%; margin:16px auto 0px;">
		...
		<div style="float:right;width:29.5%;height:518px; border-bottom:0px solid #95b8e7;border-left:1px solid #95b8e7;border-top:none;">
			<h1 style="height:30px;font-size: 16px;" align="center">您选择的建设项目</h1>
			<table id="choseedata">
			</table>
		</div>
	</div>
...
$(document).ready(function(){
	 ...
	 * 选择执法对象
	 */
	 $("#selectlawobjId").click(function(){
		var hylx = $("#hylx").combobox('getValue');
		if(hylx == ''){
			alert("请先选择行业类型！");
		}else{
			var href="choseeLawobj.htm?type=list&industryId="+hylx;
    		var width=800;
		  	var height=400;
		  	...
		  	//layer.full(index);
			//$("#selectlawobjId").colorbox({iframe:true,width:"600", height:"600",href:"choseeLawobj.htm?type=list&industryId="+hylx});
		}
	 });
	...
	$("#infectlist").height($("#main").outerHeight() - $("#questionContainer").outerHeight() -34);
	$('#data').datagrid({
		rownumbers: true,
		singleSelect: false,
		pagination:true,
	...
	$("#xinjian").click(function(){
		//var href="jsxmEdit.htm";
		//parent.parent.layerIframe(2,href,"新建建设项目","1000","600");
