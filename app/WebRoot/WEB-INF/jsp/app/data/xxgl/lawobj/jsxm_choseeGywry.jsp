   ...
   <form id="queryForm" method="post">
				...
				<table class="dataTable" width="100%"  bordercolor="#d4d4d4" cellpadding="0" cellspacing="0">
					<tr style="height:70px;">
						...
						<td>
							<input class="y-text" type="text" id="kzlx" name="kzlx" style="width: 127px;"/>
						</td>
					</tr>
					<tr>
...
<div id="layer1" class="layer"></div>
		<div class="h1_1 topMask" id="divTitle">选择工业污染源</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryGywryList.json?isActive=Y',
		columns:[[
...
$('#queryForm').submit(function(){  
    $("#queryForm").ajaxSubmit({
         ...
         url: 'queryGywryList.json', // 需要提交的 url
         data: {
             'isActive': 'Y'
         },
...
function info(id){
	var href="gywryInfo.htm?id="+id;
	parent.parent.parent.layerIframe(2,href,"查看工业污染源","1000","575");
	//$.colorbox({iframe:true,width:"800", height:"600", scrolling:false, href:"gywryInfo.htm?id="+id});
