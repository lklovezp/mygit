...
<div id="searchForm" class="searchForm" style="padding-top:10px;padding-bottom:21px;">
					...
					<tr style="height:70px;">
						...
						<td>
							<input class="y-text" style="width:127px;" type="text" id="ssxzq" name="regionId"/>
						</td>
						<th width="120">
							行业类型：
						</th>
						<td>
							<input class="y-text" type="text" id="hylx" name="industryId" style="width: 127px;"/>
						</td>
					</tr>
					<tr>
...
<div id="layer1" class="layer"></div>
		<div class="h1_1 topMask" id="divTitle">选择三产信息</div>
...
function info(id){
	var href="scxxInfo.htm?id="+id;
	parent.parent.parent.layerIframe(2,href,"查看三产信息","1000","575");
	//$.colorbox({iframe:true,width:"800", height:"550", scrolling:true, href:"scxxInfo.htm?id="+id});
	//All.ShowModalWin('scxxInfo.htm?id='+id, '查看三产信息');
}
...
function select(data){
			...
			arr = data.split(",");
			<c:if test="${type=='edit'}">
				/*$.messager.confirm('选择三产', "<table><tr><td>是否覆盖建设项目基础信息（</td></tr><tr><td>单位名称、</td></tr><tr><td>单位地址、</td></tr><tr><td>法定代表人、</td></tr><tr><td>法定代表人联系电话、<tr><td>环保负责人、</td></tr><tr><td>环保负责人联系电话）?</td></tr><div>", function(r){
					if (r){
