...
<html>
	...
	<body>
		...
		<div id="layer1" class="layer"></div>
            <h1 id="divTitle" class="h1_1 topMask">选择娱乐业信息</h1>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryYlyList.json?isActive=Y',
		...
		columns:[[
			...
			{field:'name',title:'娱乐业名称', align:"left", halign:'center',width:100},
...
function info(id){
	...
	var width=screen.width * 0.8;
  	...
  	var title='查看娱乐业信息';
  	parent.parent.layerIframe(2,'ylyInfo.htm?id='+id,title,width,height);
}
</script>