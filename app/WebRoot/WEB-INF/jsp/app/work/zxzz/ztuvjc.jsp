...
<head>
	...
	<title>总有机碳（TOC）污染源自动监控设施重点检查表</title>
...
<div class="headTitle">总有机碳（TOC）污染源自动监控设施重点检查表</div>
...
<input type="hidden" id="id" name="id" value="${id}" />
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="formtable">
		...
		<tr>
			...
			<td colspan="5" align="left">
				1、载气采用空气或氮气，氮气纯度在99.99%以上，载气流量在登记备案的范围内，采用空气为载气必须有去除二氧化碳的空气精制装置，采用氮气为载气，在供给器和氧化反应器之间必须设置氧气混入装置
		...
		<tr>
			<td colspan="5" align="left">
				2、干式氧化反应器燃烧管温度在680～1000℃，或在登记备案的范围内
			...
			<td colspan="5" align="left">
				2、供给器和氧化反应器之间无氧气混入装置，或氧气混入装置无效
		...
		<tr>
			...
			<td colspan="5" align="left">
				7、气液分离器中冷凝器的温度高于露点温度，或超过登记备案范围
		...
		<tr>
			...
			<td colspan="5" align="left">
				...
				<c:if test="${zxzzForm.sf10000032 == '1'}">
					<input type="checkbox" name="sf10000032" id="sf10000032" value="1" checked/>
				</c:if>
				<c:if test="${zxzzForm.sf10000032 != '1'}">
					<input type="checkbox" name="sf10000032" id="sf10000032" value="1"/>
				</c:if>
			</td>
		</tr>
