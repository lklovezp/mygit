...
.formtable, .formtable th, .formtable td{border-color:#dddddd;}
	...
	<body>
		<div class="h1_1" id="divTitle">服务业信息</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap:false,
		url:'queryFwyList.json?isActive=Y&regionid=${regionid}',
		onLoadSuccess:function(data){
			$(this).datagrid('doCellTip',{'max-width':'300px','delay':500});
		},
		columns:[[
			{field:'id',hidden:true},
			{field:'name',title:'服务业名称', align:"left", halign:'center',width:100},
...
function info(id){
	...
	var height=screen.height*0.8-50;
	var title='查看服务业信息';
	parent.layerIframe(2,'fwyInfo.htm?id='+id,title,width,height);
}
</script>