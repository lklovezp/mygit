 ...
 * @version 
 */
 @Service("TDataXqyzManagerImpl")
public class XqyzManagerImpl extends ManagerImpl implements XqyzManager{


/** 日志 */
	private static final Log log = LogFactory.getLog(XqyzManagerImpl.class);
	 ...
	 * @throws AppException
	 */
	public TDataLawobjf saveXqyz(XqyzForm frm) throws AppException{
       ...
       TDataXqyz po1old= new TDataXqyz();
   
    
       if(frm.getLawobjfid()!=null && frm.getLawobjfid()!=""){
			po1= (TDataXqyz) this.getXqyz(frm.getLawobjfid());
       ...
       po1.setYzmj(frm.getYzmj());
       
       
       po1.setXqyzzl(frm.getXqyzzl());
       
       
       po1.setCls(frm.getCls());
       
       
       po1.setChuls(frm.getChuls());
...
/**
	...
	public void editXqyz(XqyzForm frm){
       ...
       TDataXqyz po=this.getXqyz(frm.getId());
       ...
       frm.setYzmj(po.getYzmj());
       
       
       frm.setXqyzzl(po.getXqyzzl());
       
       
       frm.setCls(po.getCls());
       
       
       frm.setChuls(po.getChuls());
	...
	public TDataXqyz getXqyz(String lawobjid) {
		...
		TDataXqyz xqyz = null;
		String hsql = " from TDataXqyz where lawobjf.id=?";
		List<TDataXqyz> re = this.dao.find(hsql, lawobjid);
		if (re.isEmpty()) {
			return null;
		} else {
			xqyz = re.get(0);
	...
	public void delXqyz(String lawobjid) {
		// TODO Auto-generated method stub
		TDataXqyz del = this.getXqyz(lawobjid);
