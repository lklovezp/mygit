 ...
 * @version 
 */
 @Service("TDataYyManagerImpl")
public class YyManagerImpl extends ManagerImpl implements YyManager{


/** 日志 */
	private static final Log log = LogFactory.getLog(YyManagerImpl.class);
	...
	public TDataLawobjf saveyy(YyForm frm) throws AppException, ParseException{
       ...
       this.dao.save(po);
		    ...
		    TDataYy po1old= new TDataYy();
		if(frm.getLawobjfid()!=null && frm.getLawobjfid()!=""){
			po1= (TDataYy) this.getyy(frm.getLawobjfid());
       ...
       po1.setYzbm(frm.getYzbm());
       
       
       po1.setSxzz(frm.getSxzz());
       
       po1.setIsActive(YnEnum.Y.getCode());
       
       
       po1.setZyzzz(frm.getZyzzz());
       
       
       po1.setFsaqxkz(frm.getFsaqxkz());
       
       
       po1.setFsysl(frm.getFsysl());
       
       
       po1.setCws(frm.getCws());
...
/**
	...
	public void edityy(YyForm frm){
    	...
    	TDataYy po=this.getyy(frm.getId());
       ...
       frm.setYzbm(po.getYzbm());
       
       
       frm.setSxzz(po.getSxzz());
       
       
       frm.setZyzzz(po.getZyzzz());
       
       
       frm.setFsaqxkz(po.getFsaqxkz());
       
       
       frm.setFsysl(po.getFsysl());
       
       
       frm.setCws(po.getCws());
	...
	public TDataYy getyy(String lawobjid) {
		...
		TDataYy yy = null;
		String hsql = " from TDataYy where lawobjf.id=?";
		List<TDataYy> re = this.dao.find(hsql, lawobjid);
		if (re.isEmpty()) {
			return null;
		} else {
			yy = re.get(0);
	...
	public void delYy(String lawobjid) {
		// TODO Auto-generated method stub
		TDataYy del = this.getyy(lawobjid);
