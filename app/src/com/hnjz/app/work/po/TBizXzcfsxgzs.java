...
public class TBizXzcfsxgzs extends BaseObject {
	/** 任务ID */
	...
	private String jlnr;
	/** 列举证据形式，阐述要证明的内容 */
	private String wfajzj;
	/** 违反的法律法规 */
	private String rules;
	/** 依据的法律法规 */
	private String measure;
	/** 阐述适用行政处罚裁量基准制度 */
	private String xzcfzd;
	/** 行政处罚 */
	private String xzcf;
	/** 联系人 */
	private String lxr;
	...
	public String getWfajzj() {
		return wfajzj;
	}
	public void setWfajzj(String wfajzj) {
		this.wfajzj = wfajzj;
	}
	...
	public String getXzcfzd() {
		return xzcfzd;
	}
	public void setXzcfzd(String xzcfzd) {
		this.xzcfzd = xzcfzd;
	}
