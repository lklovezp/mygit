...
public class LoginLogController {
	 ...
	 * 返回值：
	 */
	@RequestMapping(value = "/exportLogTimesList.json")
	public void exportLogTimesList(ModelMap model,String areaId,String name,String starttime,String endtime,HttpServletResponse res){
		loginLogManager.exportLogTimesList( areaId, name,starttime,endtime,res);
	}
	/**
	 * 绩效考核：登录次数详情
	 * 
