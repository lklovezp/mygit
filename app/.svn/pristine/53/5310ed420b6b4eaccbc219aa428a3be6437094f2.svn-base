...
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwmc'  data-options='required:true'  id='dwmc' >${ysyForm.dwmc}</textarea></td>

<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属行政区：</td>
<td>
<input class='i-text' type='text'  name='ssxzq' id='ssxzq' value='${ysyForm.ssxzq}' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbr' id='fddbr' value='${ysyForm.fddbr}' data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbrdh' id='fddbrdh' value='${ysyForm.fddbrdh}' data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzr' id='hbfzr' value='${ysyForm.hbfzr}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzrdh' id='hbfzrdh' value='${ysyForm.hbfzrdh}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
经度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='jddu' id='jddu' value="${ysyForm.jddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdfen' id='jdfen' value="${ysyForm.jdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdmiao' id='jdmiao'value="${ysyForm.jdmiao}"/>秒</td>
<td width='150' bgcolor='#edfaff' align='right'>
纬度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='wddu' id='wddu' value="${ysyForm.wddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdfen' id='wdfen' value="${ysyForm.wdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdmiao' id='wdmiao' value="${ysyForm.wdmiao}"/>秒</td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>地址：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwdz'  data-options='required:true'  id='dwdz' >${ysyForm.dwdz}</textarea></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>营业执照注册号：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yyzzzch' id='yyzzzch' value='${ysyForm.yyzzzch}' data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
发证时间：</td>
<td>
<input class='easyui-datebox' type='text'  name='fzsj'  id='fzsj' value='${ysyForm.fzsj}' data-options='editable:false' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
底商：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='ds' id='ds' value='${ysyForm.ds}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
位于几层：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='wyjc' id='wyjc' value='${ysyForm.wyjc}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
住宅：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zz' id='zz' value='${ysyForm.zz}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
商服：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox' name='sf' id='sf' value=''>${ysyForm.sf}</textarea>
</td>
<td width='150' bgcolor='#edfaff' align='right'>
周围环境：</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='zwhj'  id='zwhj' value=''>${ysyForm.zwhj}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
面积㎡：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='mj' id='mj' value='${ysyForm.mj}'/></td>

<td width='150' bgcolor='#edfaff' align='right'>
桌子：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zzi' id='zzi' value='${ysyForm.zzi}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
椅子：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yz' id='yz' value='${ysyForm.yz}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
人员：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='ry' id='ry' value='${ysyForm.ry}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
包厢：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='bx' id='bx' value='${ysyForm.bx}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
天然气：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='trq' id='trq'  value='${ysyForm.trq}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
液化气：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yhq' id='yhq' value='${ysyForm.yhq}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
煤：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='mt' id='mt' value='${ysyForm.mt}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
灶眼：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zy' id='zy' value='${ysyForm.zy}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
制冰机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='zbj' id='zbj' value='${ysyForm.zbj}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
冷凝机组：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='lnjz' id='lnjz' value='${ysyForm.lnjz}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
和面机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hmj' id='hmj' value='${ysyForm.hmj}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
豆浆机：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='djj' id='djj' value='${ysyForm.djj}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
排气风机（台）：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pqfj' id='pqfj'  value='${ysyForm.pqfj}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
油烟排放情况：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yypfqk' id='yypfqk' value='${ysyForm.yypfqk}' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
污染防治设施安装时间：</td>
<td>
<input class='easyui-datebox' type='text'  name='wrfzssazsj'  id='wrfzssazsj'  value='${ysyForm.wrfzssazsj}'  data-options='editable:false' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
是否正常运行：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='sfzcyx' id='sfzcyx' value='${ysyForm.sfzcyx}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
排油烟管道是否超出楼顶：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pyygdsfccld' id='pyygdsfccld'  value='${ysyForm.pyygdsfccld}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
厂家：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='cj' id='cj' value='${ysyForm.cj}'/></td>
<td width='150' bgcolor='#edfaff' align='right'>
风量：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fl' id='fl' value='${ysyForm.fl}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
清洗时间：</td>
<td>
<input class='easyui-datebox' type='text'  name='qxsj'  id='qxsj'  value='${ysyForm.qxsj}' data-options='editable:false' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
维修时间：</td>
<td>
<input class='easyui-datebox' type='text'  name='wxsj'  id='wxsj'  value='${ysyForm.wxsj}' data-options='editable:false' /></td>
</tr>
...
<td>
<input class='i-text' type='text'  name='ssjgbm' id='ssjgbm'  value='${ysyForm.ssjgbm}' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
企业状态：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qyzt' id='qyzt' value='${ysyForm.qyzt}'/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
所属网格：</td>
<td>
<input class='i-text ' type='text'  name='sswgqy' id='sswgqy' value="${ysyForm.sswgqy}"/></td>
...
备注：</td>
<td  colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='bz'  id='bz' >${ysyForm.bz}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
...
$('#sfzcyx').combobox({url:'sfList.json',valueField:'id',textField:'name'});
$('#pyygdsfccld').combobox({url:'sfList.json',valueField:'id',textField:'name'});	
	//设置建设项目转过来的属性值
	...
	$("#fjlx").combobox({
		url:'fjlxList.json?enumName=YSY',
		valueField:'id',
		textField:'name'
	});
