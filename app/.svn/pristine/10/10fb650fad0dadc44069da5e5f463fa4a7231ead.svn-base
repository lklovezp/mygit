...
<%-- <div id="searchForm" class="searchForm" style="padding-top:10px;padding-bottom:21px;top:30px">
   <table class="queryTable" width="98%" border="0" cellpadding="0" cellspacing="0" style=" margin:0 auto">
     <tr>
       ...
       <th width="11.3%">人员</th>
       <td width="22%"><input type="text" class="y-text" id="tasktypeid" name="tasktypeid"/></td>
...
<div class="dataDiv" style="width:100%; margin:16px auto 25px;">
   <div class="sttsTab_con" id="con1">
				...
				<div id="rw" style="width: 550px;height:300px;float:left;"></div>
				<div id="jc" style="width: 550px;height:300px;float:left;"></div>
				<div id="dl" style="width: 1100px;height:400px;float:left;"></div>
			...
			<div class="sttsTab_con" id="con2" style="display:none;">
				<div id="rw2" style="width: 550px;height:300px;float:left;"></div>
				<div id="jc2" style="width: 550px;height:300px;float:left;"></div>
				<div id="dl2" style="width: 1100px;height:400px;float:left;"></div>
				<script type="text/javascript">
