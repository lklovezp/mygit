...
<head>
	...
	<title>固定污染源烟气连续监测系统现场核查表</title>
...
<div class="headTitle">固定污染源烟气连续监测系统现场核查表  （满分100分）</div>
...
<input type="hidden" id="id" name="id" value="${id}" />
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="formtable">
		...
		<tr>
			...
			<td colspan="4" align="left">
				有颗粒物、SO2、NOX污染物监测系统如不需装，须已向责任环保部门备案
			</td>
			<td colspan="2" align="left">
				符合得6分，缺1项扣2分
			</td>
		...
		<tr>
			...
			<td colspan="1" align="center">
				<input id="sf10000045" name="sf10000045" style="width:100px;" value="${zxzzForm.sf10000045 }" maxlength='1' onkeyup="value=value.replace(/[^\d\.]/g,'');SumNum();"></input>
			</td>
			<td colspan="3" align="center">
		...
		<tr>
			<td colspan="4" align="left">
				过量空气系数α：燃煤锅炉65t/h以下为1.8，以上为1.4；火电厂1997年前投运为1.7，之后为1.4；燃油燃气锅炉为1.2
			</td>
			<td colspan="2" align="left">
				正确得2分
			</td>
		...
		<tr>
			...
			<td colspan="1" align="center">
				<input id="sf10000049" name="sf10000049" style="width:100px;" value="${zxzzForm.sf10000049 }" maxlength='2' onkeyup="value=value.replace(/[^\d\.]/g,'');SumNum();"></input>
			</td>
			<td colspan="3" align="center">
		...
		<tr>
			...
			<td colspan="1" align="center">
				<input id="sf10000071" name="sf10000071" style="width:100px;" value="${zxzzForm.sf10000071 }" maxlength='1' onkeyup="value=value.replace(/[^\d\.]/g,'');SumNum();"></input>
			</td>
			<td colspan="3" align="center">
				<input id="sf10000072" name="sf10000072" style="width:100px;" value="${zxzzForm.sf10000072 }"></input>
			</td>
		</tr>
		<tr>
			<td colspan="3" align="center">
			...
			<td colspan="1" align="center">
				<!-- <span id="sf10000073"></span> -->
				<input type="text" id="sf10000073" name="sf10000073" value="${zxzzForm.sf10000073 }"  readonly="readonly"/>  
			</td>
...
function SumNum(){
	 ...
	 var a36 = eval(document.getElementById("sf10000071").value);
