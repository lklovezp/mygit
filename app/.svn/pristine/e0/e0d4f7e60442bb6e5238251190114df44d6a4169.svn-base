...
.formtable, .formtable th, .formtable td{border-color:#dddddd;}
	...
	<body>
		<div class="h1_1" id="divTitle">医院信息</div>
		<div class="divContainer" id="questionContainer">
			<form id="queryForm" action="queryYyxxList.json?isActive=Y" method="post">
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap:false,
		url:'queryYyxxList.json?isActive=Y&regionid=${regionid}',
...
function info(id){
	...
	var width=screen.width * 0.8;
  	...
  	var title='查看医院信息';
  	parent.layerIframe(2,'yyxxInfo.htm?id='+id,title,width,height);
