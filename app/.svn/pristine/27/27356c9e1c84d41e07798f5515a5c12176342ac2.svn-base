...
<body>
	...
	<ul class="lookupinfo_a clearfix" id="ul">
        ...
        <li><a href="xxcx_xzcfInfo.htm?lawobjid=${lawobj.id}"  target="lookupframe" hidefocus="true" value="xz">行政处罚</a></li>
        <li><a href="infoFj.htm?id=${lawobj.id}"  target="lookupframe" hidefocus="true"  value="fj">附件信息</a></li>
    </ul>
