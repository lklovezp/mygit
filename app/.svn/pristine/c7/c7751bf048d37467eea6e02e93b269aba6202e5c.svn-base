						...
						<tr>
							...
							<td>
								<input class="y-text" type="text" style="width:200px" id="name"
									name="name" value="${serverForm.name}" />
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<input class="y-text" type="text" style="width:200px" id="url" name="url"
	...
	$(document).ready(function() {
		...
		$("#myform").validate( {
			...
			submitHandler : function(form) {
				if (!check(document.getElementById("url"))){
					$.messager.alert('保存角色:', "服务地址必须以“/”结尾");
					return;
				}
				$(form).ajaxSubmit( {
					type : "post",
