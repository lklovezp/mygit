...
统一社会信用代码：</td>
<td colspan='3'>
<input class='i-text easyui-validatebox' type='text'  name='tyshxydm' id='tyshxydm' value="${xqyzForm.tyshxydm}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>畜禽养殖场名称：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwmc'  data-options='required:true'  id='dwmc' value="" >${xqyzForm.dwmc}</textarea></td>
...
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='zzjgdm'  data-options='required:true'  id='zzjgdm' value="" >${xqyzForm.zzjgdm}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>单位名称：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='xqyzcmc'  data-options='required:true'  id='xqyzcmc' value="">${xqyzForm.xqyzcmc}</textarea></td>
</tr>
...
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwdz'  data-options='required:true'  id='dwdz' value=''>${xqyzForm.dwdz}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属行政区：</td>
<td >
<input class='i-text' type='text'  name='ssxzq' id='ssxzq' value='${xqyzForm.ssxzq}' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>行业：</td>
<td >
<input class='i-text' type='text'  name='hylx' id='hylx' value='${xqyzForm.hylx}' /></td>
</tr>
...
经度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='jddu' id='jddu' value="${xqyzForm.jddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdfen' id='jdfen' value="${xqyzForm.jdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdmiao' id='jdmioa'value="${xqyzForm.jdmiao}"/>秒</td>
<td width='150' bgcolor='#edfaff' align='right'>
纬度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='wddu' id='wddu' value="${xqyzForm.wddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdfen' id='wdfen' value="${xqyzForm.wdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdmiao' id='wdmiao' value="${xqyzForm.wdmiao}"/>秒</td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbr' id='fddbr' value="${xqyzForm.fddbr}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbrdh' id='fddbrdh' value="${xqyzForm.fddbrdh}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzr' id='hbfzr' value="${xqyzForm.hbfzr}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzrdh' id='hbfzrdh' value="${xqyzForm.hbfzrdh}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>营业执照注册号：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yyzzzch' id='yyzzzch' value="${xqyzForm.yyzzzch}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
排污许可证：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pwxkz' id='pwxkz' value="${xqyzForm.pwxkz}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
废水排放口个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fspfks' id='fspfks' value="${xqyzForm.fspfks}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
废气排放口个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fqpfks' id='fqpfks' value="${xqyzForm.fqpfks}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
噪声源个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='zsygs' id='zsygs' value="${xqyzForm.zsygs}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
固废堆放场个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='gfdfcgs' id='gfdfcgs' value="${xqyzForm.gfdfcgs}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
污染防治设施数量：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='wryfzsssl' id='wryfzsssl'  value="${xqyzForm.wryfzsssl}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
养殖面积：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='yzmj' id='yzmj'  value="${xqyzForm.yzmj}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
存栏数</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='cls' id='cls' value="${xqyzForm.cls}"/></td>

<td width='150' bgcolor='#edfaff' align='right'>
出栏量：</td>
<td>
<input class='i-text' type='text'  name='chuls' id='chuls' value="${xqyzForm.chuls}" /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
所属网格：</td>
<td>
<input class='i-text ' type='text'  name='sswgqy' id='sswgqy' value="${xqyzForm.sswgqy}"/></td>
...
所属监管部门：</td>
<td>
<input class='i-text' type='text'  name='ssjgbm' id='ssjgbm' value="${xqyzForm.ssjgbm}" /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>企业状态：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qyzt' id='qyzt' value="${xqyzForm.qyzt}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
畜禽养殖种类：</td>
<td colspan="3">
<input class='i-text' type='text'  name='xqyzzl'  id='xqyzzl' value="${xqyzForm.xqyzzl}"/></td>
</tr>
<!-- <tr>
<td width='150' bgcolor='#edfaff' align='right'>
所属网格：</td>
...
$('#hylx').combobox({required:true,url:'industryList.json?lawobjType=6',valueField:'id',textField:'name'});
...
;
	...
	$("#fjlx").combobox({
		url:'fjlxList.json?enumName=XQYZ',
		valueField:'id',
		textField:'name'
	});
