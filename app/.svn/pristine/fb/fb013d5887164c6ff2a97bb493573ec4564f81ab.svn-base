...
<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择医院信息</div>
	<div id="main" style="padding:0px;margin:0 auto; width:99%;height:518px; border:1px solid #95b8e7; ">
		...
		<div style="float:right;width:29.5%;height:518px; border-bottom:0px solid #95b8e7;border-left:1px solid #95b8e7;border-top:none;">
			<h1 style="height:30px;font-size: 16px;" align="center">您选择的医院信息</h1>
			<table id="choseedata">
			</table>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryYyxxList.json?isActive=Y&orgId='+$('#ssjgbm').val(),
	...
	$('#choseedata').datagrid({
		...
		columns:[[
			...
			{field:'hbfzrlxdh',hidden:true},
			{field:'regionid',hidden:true},
			{field:'lawobjname',title:'医院名称', align:"left", halign:'center',width:100},
	...
	$("#xinjian").click(function(){
		//var href="yyxxEdit.htm";
		//parent.parent.layerIframe(2,href,"新建医院","1000","600");
