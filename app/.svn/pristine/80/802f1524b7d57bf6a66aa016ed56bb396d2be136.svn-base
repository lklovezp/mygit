...
<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择建筑工地信息</div>
	<div id="main" style="padding:0px;margin:0 auto; width:99%;height:518px; border:1px solid #95b8e7; ">
				...
				<form id="queryForm" action="queryJzgdList.json" method="post">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td>
								<input class="y-text" type="text"  name="sgdwmc" id="" style="width:127px;"/>
							</td>
							<th width="150" >
								所属监管部门
							</th>
		...
		<div class="divContainer"  style="float:right;width:29.5%;height:518px; border-bottom:0px solid #cff1ff;border-left:1px solid #cff1ff;border-top:none;">
			<h1 style="height:30px;font-size: 16px;" align="center">您选择的建筑工地信息</h1>
			<table id="choseedata">
			</table>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryJzgdList.json?isActive=Y&orgId='+$('#ssjgbm').val(),
	...
	$("#xinjian").click(function(){
		//var href="jzgdEdit.htm";
		//parent.parent.layerIframe(2,href,"新建建筑工地","1000","600");
