...
<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择饮食业信息</div>
	<div id="main" style="padding:0px;margin:0 auto; width:99%;height:518px; border:1px solid #95b8e7; ">
		...
		<div style="float:right;width:29.5%;height:518px; border-bottom:0px solid #95b8e7;border-left:1px solid #95b8e7;border-top:none;">
			<h1 style="height:30px;font-size: 16px;" align="center">您选择的饮食业企业信息</h1>
			<table id="choseedata">
			</table>
		</div>
	</div>
...
$('#data').datagrid({
	...
	fitColumns:true,
	nowrap: false,
	url:'queryYsyList.json?isActive=Y&orgId='+$('#ssjgbm').val(),
...
$("#xinjian").click(function(){
	//var href="ysyEdit.htm";
	//parent.parent.layerIframe(2,href,"新建饮食业信息","1000","600");
