...
.tabs li a.tabs-inner {
	...
	<body style="padding-bottom: 70px;">
		...
		<form id="queryForm" action="savegl.json" method="post">
		 <input type="hidden" id="fid" name="fid" value="" />
			<input type="hidden" id="id" name="id" value="${glForm.id}"/>
			<input type="hidden" id="lawobjtypeid" name="lawobjtypeid" value="${lawobjtypeid}"/>
			<input type="hidden" id="lawobjfid" name="lawobjfid" value="${glForm.lawobjfid}"/>
			<input type="hidden" id="jsxmid" name="jsxmid" value="${glForm.jsxmid}"/>
			<input type="hidden" id="qyscztj" name="qyscztj" value='${glForm.qysczt}'/>
...
统一社会信用代码：</td>
<td colspan='3'>
<input class='i-text easyui-validatebox' type='text'  name='tyshxydm' id='tyshxydm' value=""/></td>
</tr>-->
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>组织机构代码：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='zzjgdm'  data-options='required:true'  id='zzjgdm' value="" >${glForm.zzjgdm}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>单位名称：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwmc'  data-options='required:true'  id='dwmc' value="">${glForm.dwmc}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属行政区：</td>
<td colspan='3'>
<input class='i-text' type='text'  name='ssxzq' id='ssxzq' value='${glForm.ssxzq}' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>地址：</td>
<td colspan='3'>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  name='dwdz'  data-options='required:true'  id='dwdz' value=''>${glForm.dwdz}</textarea></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
经度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='jddu' id='jddu' value="${glForm.jddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdfen' id='jdfen' value="${glForm.jdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='jdmiao' id='jdmiao'value="${glForm.jdmiao}"/>秒</td>
<td width='150' bgcolor='#edfaff' align='right'>
纬度：</td>
<td>
<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='3' name='wd' id='wddu' value="${glForm.wddu}"/>度<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdfen' id='wdfen' value="${glForm.wdfen}"/>分<input class='i-text easyui-numberbox' type='text' style='width:50px' maxLength='2' name='wdmiao' id='wdmiao' value="${glForm.wdmiao}"/>秒</td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbr' id='fddbr' value="${glForm.fddbr}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>法定代表人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='fddbrdh' id='fddbrdh' value="${glForm.fddbrdh}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzr' id='hbfzr' value="${glForm.hbfzr}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
环保负责人联系电话：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='hbfzrdh' id='hbfzrdh' value="${glForm.hbfzrdh}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>营业执照注册号：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='yyzzzch' id='yyzzzch' value="${glForm.yyzzzch}" data-options='required:true' title='限填150字以内' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' /></td>
<td width='150' bgcolor='#edfaff' align='right'>
排污许可证：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='pwxkz' id='pwxkz' value="${glForm.pwxkz}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
废水排放口个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fspfks' id='fspfks' value="${glForm.fspfks}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
废气排放口个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='fqpfks' id='fqpfks' value="${glForm.fqpfks}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
噪声源个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='zsygs' id='zsygs' value="${glForm.zsygs}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
固废堆放场个数：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='gfdfcgs' id='gfdfcgs' value="${glForm.gfdfcgs}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
污染防治设施数量：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='wryfzsssl' id='wryfzsssl'  value="${glForm.wryfzsssl}"/></td>
<td width='150' bgcolor='#edfaff' align='right'>
锅炉数（台）：</td>
<td>
<input class='i-text easyui-numberbox' min='0' type='text'  name='gls' id='gls'  value="${glForm.gls}"/></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>用途</td>
<td>
<textarea title='限制输入150字符'  style='width:350px;' maxlength='150' onKeyUp='return textMaxLen(this);' onBlur='return textMaxLen(this);' rows='2' class='i-text easyui-validatebox'  data-options='required:true'  name='yt' id='yt' value="" >${glForm.yt}</textarea>

<td width='150' bgcolor='#edfaff' align='right'>
蒸吨/小时：</td>
<td>
<input class='i-text' type='text'  name='zd' id='zd' value="${glForm.zd}" /></td>
</tr>
<tr>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>所属网格区域：</td>
<td>
<input class='i-text ' type='text'  name='sswgqy' id='sswgqy' value="${glForm.sswgqy}"/></td>
<!--  <td width='150' bgcolor='#edfaff' align='right'>
...
<c:if test="${glForm.id !=null&& glForm.id!=''}">
<input class='i-text' type='text' style='border-left:0px;border-top:0px;border-right:0px;border-bottom:1px '  name='cjr' id='cjr' value="${glForm.cjr}" /></td>
</c:if>
</tr>
...
所属监管部门：</td>
<td>
<input class='i-text' type='text'  name='ssjgbm' id='ssjgbm' value="${glForm.ssjgbm}" /></td>
<td width='150' bgcolor='#edfaff' align='right'>
<label class='requiredLabel'>*</label>企业状态：</td>
<td>
<input class='i-text easyui-validatebox' type='text'  name='qyzt' id='qyzt' value="${glForm.qyzt}"/></td>
</tr>
