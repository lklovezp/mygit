...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><html>
	...
	<body style="padding-bottom: 70px;">
		<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择工业污染源</div>
		<div id="main" class="main" style="padding:0px;margin:0 auto; width:98%; height:380px; border:1px solid #95b8e7;">
				...
				<form id="queryForm" action="queryGywryList.json" method="post">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="100">
								<input class="y-text" style="width:150px;" type="text" name="regionId" id="ssxzq"/>
							</td>
							<th width="100" align="right">
								控制类型：
							</th>
							<td>
								<input class="y-text" type="text" id="kzlx" name="kzlx" style="width:150px;"/>
							</td>
						</tr>
			...
			<div style="float:right;width:24.5%;height:380px; border-bottom:0px solid #95b8e7;border-left:1px solid #95b8e7;border-top:none;">
				 <h1 style="height:30px;font-size: 16px;" align="center">您选择的工业污染源信息</h1>
				<table id="choseedata" >
				</table>
			</div>
		</div>
