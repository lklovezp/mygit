...
<html>
	...
	<body>
		...
		<div id="layer1" class="layer"></div>
            <h1 id="divTitle" class="h1_1 topMask">选择制造业信息</h1>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryZzyList.json?isActive=Y',
		...
		columns:[[
			...
			{field:'name',title:'制造业名称', align:"left", halign:'center',width:100},
...
function info(id){
	...
	var width=screen.width * 0.8;
  	...
  	var title='查看制造业信息';
  	parent.parent.layerIframe(2,'zzyInfo.htm?id='+id,title,width,height);
}
</script>