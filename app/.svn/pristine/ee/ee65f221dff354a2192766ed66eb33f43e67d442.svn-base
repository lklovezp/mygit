...
<body>
	<div class="headTitle" style="font-size:16px; padding-top:20px;">（听证）告知书送达回证</div>
	<form id="queryForm" action="" method="post">
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0" class="formtable">
			<input type="hidden" value="${tzgzssdhzForm.id}" id="id" name="id">
			<input type="hidden" value="${tzgzssdhzForm.taskId}" id="taskId" name="taskId">
			<input type="hidden" value="${tzgzssdhzForm.taskTypeId}" id="pid" name="taskTypeId">
			<input type="hidden" value="${Androw}" id="Androw" name="Androw"/>
			<tr>
				<td align="center" colspan="2"><input class="i-text easyui-validatebox" type="text" value="${tzgzssdhzForm.title}" id="title" name="title">
				送达回执</td>
