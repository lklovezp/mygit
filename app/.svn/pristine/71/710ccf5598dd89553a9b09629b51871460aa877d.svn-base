...
<div id="oper" style="width:95%; margin:-23px  auto 0px;" class="t-r">
    <input type="button" class="bTn directory_save directory_comwidth"  value="任务派发" onclick="showDialog()"/>
    <input type="button" class="bTn directory_save directory_comwidth" value="批量派发" onclick="javascript: batchDistribute()" />
</div>
<div class="divContainer" id="rbblist" style=" width:100%; margin:16px auto 0px;">
    <table id="data" fit="true" ></table>
</div>
<!--执法检查弹窗-->
<div id="dailogMenu" class="dailogMenu">
    <a class="zfjc" onclick="hideDialog('pfPage.htm?rwlxType=0&lx=1')" href="#">执法检查</a>
    <a class="rcbg" onclick="hideDialog('pfPage.htm?rwlxType=24&lx=1')" href="#">日常办公</a>
    <a class="xfts" onclick="hideDialog('pfPage.htm?rwlxType=13&lx=1')" href="#">信访投诉</a>
    <span onclick="hideDialog1()">关闭</span>
</div>
