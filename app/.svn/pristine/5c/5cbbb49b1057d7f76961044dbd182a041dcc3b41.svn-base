...
.formtable, .formtable th, .formtable td{border-color:#dddddd;}
	...
	<body>
		<div class="h1_1" id="divTitle">工业污染源</div>
		<div class="divContainer" id="questionContainer">
			<form id="queryForm" action="queryGywryList.json?isActive=Y" method="post">
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap:false,
		url:'queryGywryList.json?isActive=Y&regionId=${regionid}',
