...
<html>
	...
	<body>
		<input type="hidden" id="mailId" name="mailId" value="${fileForm.pid}"/>
...
Ext.onReady(function(){
	...
	new Ext.form.Panel({
		...
		items : [ {
			...
			uploadUrl : "${ctx}/saveSendMailFuJian;jsessionid=${JSESSIONID}",//提交的action路径
