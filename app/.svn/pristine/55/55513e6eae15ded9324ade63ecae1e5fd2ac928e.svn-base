...
<div id="title" style="width: 99%;margin:16px auto 16px;font-size: 18px;" align="center">选择三产信息</div>
	<div id="main" style="padding:0px;margin:0 auto; width:99%;height:518px; border:1px solid #95b8e7; ">
				...
				<form id="queryForm" action="queryScxxList.json" method="post">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td>
								<input class="y-text" type="text" id="hylx" name="industryId" style="width:150px;"/>
							</td>
						</tr>
		...
		<div class="divContainer"  style="float:right;width:29.5%;height:518px; border-bottom:0px solid #cff1ff;border-left:1px solid #cff1ff;border-top:none;">
			<h1 style="height:30px;font-size: 16px;" align="center">您选择的三产信息</h1>
			<table id="choseedata">
			</table>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryScxxList.json?isActive=Y&orgId='+$('#ssjgbm').val(),
		...
		columns:[[
			...
			{field:'industryName',title:'行业类型', align:"center", halign:'center',width:50},
		]],
	...
	$("#xinjian").click(function(){
		//var href="scxxEdit.htm";
		//parent.parent.layerIframe(2,href,"新建三产信息","1000","600");
