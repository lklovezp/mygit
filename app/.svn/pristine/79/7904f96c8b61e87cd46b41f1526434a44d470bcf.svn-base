...
<html>
	...
	<body>
		...
		<div id="layer1" class="layer"></div>
            <h1 id="divTitle" class="h1_1 topMask">选择服务业信息</h1>
...
$(document).ready(function(){
	...
	$('#data').datagrid({
		...
		fitColumns:true,
		nowrap: false,
		url:'queryFwyList.json?isActive=Y',
		...
		onDblClickRow: function(rowIndex, rowData){
			alert(rowData.id,rowData.name,rowData.address);
...
function info(id){
	...
	var width=screen.width * 0.8;
  	...
  	var title='查看服务业信息';
  	parent.parent.layerIframe(2,'fwyInfo.htm?id='+id,title,width,height);
}
</script>