...
public class iMsgServer2000 implements InitializingBean,DisposableBean
{
private static final Log  log = LogFactory.getLog(iMsgServer2000.class);
...
public void afterPropertiesSet() throws Exception {
	log.info("初始化自定义Bean组件iMsgServer2000");
}

public void destroy() throws Exception {
	log.info("销毁自定义Bean组件iMsgServer2000");
}
