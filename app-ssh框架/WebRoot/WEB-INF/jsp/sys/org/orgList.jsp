...
<html>
	...
	<body>
		<%--<div ><p>点击查看更多查询条件</p></div>--%>
		<%--<div id="searchForm" class="searchForm" style="width: 100%; margin: 0 auto">
			...
			<div><h1 class="h1_1"  style="margin-top:20px;">部门管理</h1></div>
			<div style="width:95%; margin:-7px  auto 0px;" class="t-r">
            	<input type="button" class="bTn blue bTn_distance" id="functionAdd" value="添加" />
        	</div>
			<div class="divContainer" style="width: 95%;margin: 0 auto;margin-top: 10px;">
...
//			{dataIndex:'order'},
		...
		dataObject:{name:'部门名称',gzdw:'工作单位',note:'备注',/*order:'排序',*/isActive:'是否可用',operate:'操作'},
