...
<div class="y_twarp clearfix">
	<div class="l_p"><a href="dicMain.htm">发文类型</a></div>
    <div class="r_p cur"><a href="javascript:void(0)">收文类型</a></div>
</div>
<div class="btnDiv">
    <input  class="bTn blue" value="添加" type="button" id="dicAdd"/>
</div>
...
function edit(curObj){
	layer.open({
	       ...
	       shadeClose:false,
	       maxmin:true,
	       content:"editDic.htm?id="+curObj.id+"&type="+1
	     });
}
function del(curObj){
